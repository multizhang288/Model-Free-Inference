...
```{r Figure S.3}
#Figure S.3: Empirical rejection rate when $\bX$ is mixture normal distributed with respect to different $df$.
address = paste(root_path,"/Study 2/Adversarial Example/Intermediate Data",sep="")
file_names <- dir(address)
d = length(file_names)
Record  = NULL
for(i in 1:d)
